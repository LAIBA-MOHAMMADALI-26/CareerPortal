    ...
    <div class="container">
      <h1 class="animate-reveal animate-first">
        <h1 class="welcome-text">
          <B>Welcome To</B> <br>
          <img class="lo" src="images/1581444586955-removebg-preview.png" ><br>
...
<!-- why jaffer group -->
<div class="purpose" id="pur" >
<center>
  <div class="content-container1 vision">
...
<!-- div of purpose and vision ends -->

<!-- ..... div of chairmans message starts  -->
...
<!-- culture div slider starts here  -->
...
<script>
  // JavaScript code to implement automatic image slider
  let currentSlide = 0;
  ...
  function autoSlide() {
      showSlide();
      setTimeout(autoSlide, 2000); // 5000 milliseconds (2 seconds)
  }
